jQuery(function($) {
	...
	function parallaxScroll() {
		...
		$('.page-header-cover').css({
			'-webkit-transform' : 'translate3d(0px, ' + parallaxOffset * 0.5 + 'px, 0px)',
			'transform' : 'translate3d(0px, ' + parallaxOffset * 0.5 + 'px, 0px)',
