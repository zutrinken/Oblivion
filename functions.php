	...
	<li id="li-comment-<?php comment_ID() ?>" <?php comment_class($parent_class); ?>>
		...
		<div id="comment-<?php comment_ID(); ?>" class="comment-body">
			<div class="comment-info">
				...
				<span class="comment-reply"><?php comment_reply_link(array('reply_text' => '<i class="icon-reply"></i><span>' ._x('reply','oblivion').'</span>', 'depth' => $depth, 'max_depth' => $args['max_depth'])); ?></span>
				<div class="clear"></div>
			</div><!--comment-info-->
